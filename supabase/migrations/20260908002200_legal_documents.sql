...
select
  ...
  '20260918-2',
  date '2026-09-18',
  $legal$<h2>1. 총칙</h2><p>글자월드 운영자(이하 "운영자")는 메이플스토리 월드(MapleStory Worlds)에서 서비스되는 게임 "글자월드"의 공식 홈페이지 및 커뮤니티(이하 "서비스")를 운영하면서 「개인정보 보호법」 등 관련 법령을 준수하며, 이용자의 개인정보를 안전하게 보호하기 위하여 본 개인정보처리방침을 수립·공개합니다.</p><p>본 방침은 서비스(웹사이트) 이용과 관련하여 운영자가 수집·이용하는 개인정보에 적용됩니다. 넥슨 계정, 메이플스토리 월드 플랫폼 내 게임 이용 정보는 운영자가 수집·처리하지 않으며, 해당 정보는 넥슨(주)의 개인정보처리방침에 따릅니다.</p><h2>2. 수집하는 개인정보의 항목 및 수집 방법</h2><p><strong>①</strong>운영자는 서비스 제공을 위해 다음과 같이 최소한의 개인정보를 수집합니다.</p><table><thead><tr><th>구분</th><th>수집 항목</th><th>수집 방법</th></tr></thead><tbody><tr><td>회원가입(필수)</td><td>소셜 로그인 제공자(구글·카카오·네이버)의 회원 식별자, 이메일 주소, 닉네임, 프로필 이미지(제공 시)</td><td>간편로그인 시 해당 제공자로부터 제공받음</td></tr><tr><td>회원가입(선택)</td><td>닉네임</td><td>최초 로그인 또는 프로필 설정 시 이용자가 직접 입력</td></tr><tr><td>커뮤니티 이용</td><td>작성한 게시글·댓글, 좋아요 등 활동 기록</td><td>서비스 이용 과정에서 생성</td></tr><tr><td>1:1 문의</td><td>글자월드 계정 ID, 문의 유형, 제목, 문의 내용, 첨부파일(최대 3개)</td><td>문의 등록 시 이용자가 직접 입력·첨부</td></tr><tr><td>자동 수집</td><td>접속 IP 주소, 접속 일시, 브라우저·운영체제 정보, 서비스 이용 기록, 쿠키</td><td>서비스 이용 과정에서 자동 생성·수집</td></tr></tbody></table><p><strong>②</strong>운영자는 사상·신념, 건강, 성생활 등 민감정보와 주민등록번호 등 고유식별정보를 수집하지 않습니다.</p><p><strong>③</strong>이용자가 게시글·댓글에 스스로 공개한 정보(닉네임 포함)는 다른 이용자에게 공개되므로 게시 시 주의하여 주시기 바랍니다.</p><h2>3. 개인정보의 처리 목적</h2><ul><li>회원 식별, 가입 의사 확인 및 본인 확인(소셜 로그인 제공자의 인증 결과 확인)</li><li>로그인 세션 유지 등 계정 보호와 서비스 이용 환경 제공</li><li>커뮤니티(게시글·댓글 작성 및 표시), 뉴스·가이드 등 콘텐츠 제공</li><li>1:1 문의 접수, 답변 및 처리 결과 안내</li><li>서비스 관련 공지사항 전달</li><li>운영정책 위반 행위 및 부정 이용 방지, 이용 제한 조치의 기록·관리</li><li>접속 통계 등 비식별화된 정보를 활용한 서비스 품질 개선</li></ul><h2>4. 개인정보의 보유 및 이용 기간</h2><p><strong>①</strong>운영자는 수집·이용 목적이 달성된 때 해당 개인정보를 지체 없이 파기합니다. 회원 탈퇴 요청 시에는 재가입에 대비해 90일간 보존한 뒤 지체 없이 파기합니다(단, 관계 법령에 따른 보존 항목 제외).</p><p><strong>②</strong>탈퇴 후 90일 보존 기간 동안 같은 간편로그인 계정으로 다시 로그인하면 계정이 복구되며, 보존 기간이 지나면 다음 항목을 파기합니다.</p><ul><li>파기 항목: 이메일, 간편로그인 식별자, 닉네임, 월드 계정 UID, 프로필 코드, 프로필 사진</li><li>게시글·댓글은 유지되며, 작성자 정보는 비식별화("탈퇴한 회원")됩니다.</li></ul><p><strong>③</strong>다만 다음의 정보는 아래 기간 동안 보존합니다.</p><table><thead><tr><th>보존 항목</th><th>보존 근거</th><th>보존 기간</th></tr></thead><tbody><tr><td>운영정책 위반·부정 이용 기록(이메일, 제재 사유)</td><td>부정 이용 재발 방지(운영자 내부 방침)</td><td>회원 탈퇴 후 1년</td></tr><tr><td>1:1 문의 기록 및 첨부파일</td><td>소비자의 불만 또는 분쟁처리에 관한 기록(전자상거래 등에서의 소비자보호에 관한 법률)</td><td>3년</td></tr><tr><td>서비스 접속 기록(IP, 접속 일시)</td><td>통신비밀보호법</td><td>3개월</td></tr><tr><td>이용자가 작성한 게시글·댓글</td><td>커뮤니티 운영 연속성</td><td>탈퇴 후 90일이 지나면 작성자 정보는 비식별 처리("탈퇴한 회원")되며, 게시물은 이용자가 탈퇴 전 직접 삭제할 수 있습니다</td></tr></tbody></table><h2>5. 개인정보의 제3자 제공</h2><ul><li>운영자는 이용자의 개인정보를 제2조·제3조에서 명시한 범위 내에서만 처리하며, 이용자의 사전 동의 없이 제3자에게 제공하지 않습니다.</li><li>다만, 법령에 특별한 규정이 있거나 수사기관이 법령에 정해진 절차와 방법에 따라 요청하는 경우에는 예외로 합니다.</li></ul><h2>6. 개인정보 처리의 위탁 및 국외 이전</h2><p><strong>①</strong>운영자는 안정적인 서비스 제공을 위해 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다.</p><table><thead><tr><th>수탁자</th><th>위탁 업무</th><th>개인정보 보관 위치</th></tr></thead><tbody><tr><td>Supabase, Inc.</td><td>회원 데이터베이스·이메일 인증·첨부파일 저장 인프라 운영</td><td>대한민국(AWS 서울 리전, ap-northeast-2)</td></tr><tr><td>Vercel Inc.</td><td>웹사이트 호스팅 및 배포, 접속 로그 처리</td><td>미국 등 Vercel Inc.가 운영하는 해외 데이터센터</td></tr></tbody></table><p><strong>②</strong>위 Vercel Inc.에 대한 처리 위탁은 개인정보의 국외 이전에 해당합니다. 이전되는 항목은 접속 IP 주소, 접속 일시, 브라우저 정보 등 서비스 접속 시 자동 생성되는 정보이며, 서비스 이용 시 네트워크를 통해 이전되고, 호스팅 서비스 제공 목적으로 위탁 계약 기간 동안 보유됩니다. 이용자는 국외 이전을 거부할 수 있으나, 이 경우 서비스 이용이 제한될 수 있습니다.</p><p><strong>③</strong>운영자는 위탁 계약 시 개인정보 보호법 제26조에 따라 수탁자가 개인정보를 안전하게 처리하도록 관리·감독합니다. 위탁 업체가 변경되는 경우 본 방침을 통해 공개합니다.</p><h2>7. 개인정보의 파기 절차 및 방법</h2><ul><li><strong>파기 절차</strong>: 보유 기간이 경과하거나 처리 목적이 달성된 개인정보는 내부 방침에 따라 지체 없이 파기합니다. 회원 탈퇴 후 보존 기간(90일)이 지난 계정의 개인정보는 매일 자동 배치로 파기합니다. 법령에 따라 보존해야 하는 정보는 별도의 저장 공간으로 옮겨 보존 기간 동안만 보관합니다.</li><li><strong>파기 방법</strong>: 전자적 파일 형태의 정보는 복구·재생할 수 없는 방법으로 영구 삭제하며, 출력물은 분쇄 또는 소각하여 파기합니다.</li></ul><h2>8. 이용자와 법정대리인의 권리·의무 및 행사 방법</h2><ul><li>이용자는 언제든지 자신의 개인정보에 대한 열람, 정정, 삭제, 처리정지를 요구하거나 동의를 철회(회원 탈퇴)할 수 있습니다.</li><li>권리 행사는 서비스 내 계정 설정 또는 제10조의 개인정보 보호책임자 이메일로 요청할 수 있으며, 운영자는 요청을 받은 날부터 10일 이내에 조치합니다.</li><li>권리 행사는 법정대리인이나 위임을 받은 자를 통해서도 할 수 있으며, 이 경우 위임장을 제출해야 합니다.</li><li>다른 법령에서 열람·삭제 등을 제한하거나 해당 정보가 법령상 보존 대상인 경우 권리 행사가 제한될 수 있습니다.</li><li>이용자는 자신의 개인정보를 최신 상태로 정확하게 유지할 책임이 있으며, 타인의 개인정보를 침해하는 경우 관련 법령에 따라 처벌될 수 있습니다.</li></ul><h2>9. 개인정보의 안전성 확보 조치</h2><ul><li>운영자는 비밀번호를 수집·저장하지 않으며, 인증은 소셜 로그인 제공자의 인증 결과와 Supabase Auth 세션 토큰으로 처리됩니다.</li><li>개인정보는 전송 구간에서 TLS(HTTPS)로 암호화됩니다.</li><li>개인정보 처리 인원을 최소한으로 제한하고, 데이터베이스 접근 권한을 계정별로 분리·통제합니다.</li><li>개인정보에 대한 접근 기록을 보관하고 위·변조를 방지합니다.</li><li>개인정보 처리 인원에 대해 정기적인 보안 교육을 실시합니다.</li></ul><h2>10. 개인정보 자동 수집 장치의 설치·운영 및 거부</h2><ul><li>운영자는 로그인 상태 유지 등 서비스 제공에 필수적인 목적으로 쿠키(cookie)를 사용합니다. 광고·마케팅 목적의 쿠키는 사용하지 않습니다.</li><li>이용자는 웹 브라우저 설정에서 쿠키 저장을 거부하거나 삭제할 수 있습니다. 다만 필수 쿠키를 거부하면 로그인이 필요한 서비스 이용이 제한될 수 있습니다.</li></ul><h2>11. 만 14세 미만 아동의 개인정보</h2><p>운영자는 만 14세 미만 아동의 개인정보를 수집하지 않으며, 만 14세 미만 아동은 회원으로 가입할 수 없습니다. 만 14세 미만 아동의 가입 사실이 확인되는 경우 해당 계정과 개인정보를 지체 없이 삭제합니다.</p><h2>12. 개인정보 보호책임자 및 권익침해 구제 방법</h2><p>① 운영자는 개인정보 처리에 관한 업무를 총괄하고 관련 불만 처리 및 피해 구제를 위하여 아래와 같이 개인정보 보호책임자를 지정합니다.</p><ul><li>개인정보 보호책임자: 글자월드 운영자</li><li>이메일: contact@글자월드.co.kr</li></ul><p><strong>②</strong>이용자는 서비스 이용 중 발생한 모든 개인정보 관련 문의, 불만, 피해 구제 요청을 위 연락처로 접수할 수 있으며, 운영자는 지체 없이 답변·처리합니다.</p><p><strong>③</strong>기타 개인정보 침해에 대한 신고나 상담이 필요한 경우 아래 기관에 문의할 수 있습니다.</p><table><thead><tr><th>기관</th><th>연락처</th></tr></thead><tbody><tr><td>개인정보침해신고센터(한국인터넷진흥원)</td><td>(국번 없이) 118 / privacy.kisa.or.kr</td></tr><tr><td>개인정보분쟁조정위원회</td><td>(국번 없이) 1833-6972 / www.kopico.go.kr</td></tr><tr><td>대검찰청 사이버수사과</td><td>(국번 없이) 1301 / www.spo.go.kr</td></tr><tr><td>경찰청 사이버수사국</td><td>(국번 없이) 182 / ecrm.police.go.kr</td></tr></tbody></table><h2>13. 개인정보처리방침의 변경</h2><ul><li>본 방침의 내용 추가, 삭제 및 수정이 있을 경우 시행 최소 7일 전에 서비스 공지사항을 통해 알립니다. 다만 수집 항목, 이용 목적 등 이용자 권리에 중요한 변경이 있는 경우에는 최소 30일 전에 알립니다.</li><li>공고일자: 2026년 9월 8일 / 시행일자: 2026년 9월 18일</li></ul>$legal$,
