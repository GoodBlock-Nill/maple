 ...
 * 항상 한 줄 + 말줄임. 폰(<640px)에서는 제목이 자기 줄을 통째로 쓴다 — 뱃지·작성자와
 * 한 줄에 두면 320~390px 폭에서 2~3글자만 남아 실기기 피드백이 왔다.
 */
export const BOARD_ROW_TITLE_CLASS =
  'text-ink line-clamp-1 text-[18px] font-medium tracking-[-0.2px] sm:text-[20px]'
