 ...
 * 한 번 누를 때마다 글이 등록된다. 현재 상태는 색이 아니라 `aria-pressed` 로도
...
export const TOOLBAR_BUTTON_CLASS =
  'text-ink-muted hover:bg-sheet focus-visible:outline-focus inline-flex h-9 min-w-9 items-center justify-center rounded-[8px] px-2 text-[15px] font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-40'
