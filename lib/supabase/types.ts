...
export type FunctionArgs<TName extends FunctionName> = PublicSchema['Functions'][TName]['Args']

export type FunctionReturns<TName extends FunctionName> =
  PublicSchema['Functions'][TName]['Returns']

/* 자주 쓰는 행 타입 단축 별칭. */
export type Profile = Tables<'profiles'>
export type BoardCategory = Tables<'board_categories'>
export type PostRow = Tables<'posts'>
export type CommentRow = Tables<'comments'>
export type InquiryRow = Tables<'inquiries'>
export type FaqRow = Tables<'faqs'>
export type SiteSettings = Tables<'site_settings'>
export type GachaItemRow = Tables<'gacha_items'>
