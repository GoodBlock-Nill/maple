...
- 정책 링크 줄: 시안은 세 문서(개인정보처리방침·디스코드 운영정책·글자월드 운영정책)지만 **2026-09-15 오너 요청으로 "마케팅 정보 수신 동의"를 네 번째로 추가**했다(`FOOTER_POLICY_LINKS = POLICY_LINKS`). 375 폭에서는 2×2 격자로 접힌다(둘째 줄 첫머리 구분선 없음).
